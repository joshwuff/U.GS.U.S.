...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Separating the UI setup from the Data Fetch so it doesn't get stuck loading!
    function initWeekUI() {
        if (!weekLabel) return;
    ...
    // Set up the UI on launch so it doesn't say "Loading..." forever, but hold off on the database!
    initWeekUI(); 
});
